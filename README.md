...
### Веб‑интерфейс
На корневом маршруте `/` доступен простой UI для проверки сервиса:
- загрузите изображение;
- нажмите «Детектировать»;
- увидите отрисованные bbox и JSON‑ответ.
...
### Подход к решению
Начал с понятного и быстрого baseline.

- Модель: YOLO (Ultralytics) — быстро обучается, быстро работает и просто разворачивается в FastAPI/Docker.
- В данных логотип чаще «смотрит прямо» — базовой модели этого хватает.
- Дубликаты ускоряют обучение, но портят честность метрик. В оценке их контролировал.
- Что ещё можно было бы попробовать: RT‑DETR/DETR, YOLOv9/YOLOv10, GroundingDINO+SAM (zero‑shot), CLIP‑подсказки, синтетическое наложение логотипов.
- Обучал на RTX 2080 — не новинка, зато греет как надо :)

### Работа с данными
- Этап 1. Разметил ~100 фото в LabelImg и обучил базу. Прогнал весь набор: ≈3700 кадров с логотипом и ≈26300 без. На глаз ~80% верных; остальное — ложные/пропуски. Слабые места: редкие наклоны, нестандартные цвета, сильное размытие.
- Этап 2. Собрал ~3000 примеров, сделал аккуратный сплит 80/20 с фиксированным seed (без «утечек» похожих кадров между train/val). Остальные ~26000 оставил для повторной проверки.
- Этап 3. Добавил ~300 внешних сцен (банкоматы/наружная реклама). Детектор стал устойчивее; на банкоматах средняя уверенность держалась ~0.85.
...
Ниже — характерные примеры ложных детекций на ранних итерациях. Причины: геометрическое сходство (контрастные чёрно‑жёлтые формы, однотонные заливки, прямоугольные полосы/буквы) и недостаток «hard negative» примеров на старте.

<div align="center">
  <img src="docs/images/fp_raiffeisen.jpg" width="320"/>
  <img src="docs/images/fp_tele2.jpg" width="320"/>
  <br/>
  <img src="docs/images/fp_ringbars.jpg" width="320"/>
  <img src="docs/images/fp_excel.jpg" width="320"/>
</div>
...
### Галерея результатов
<div align="center">
  <img src="docs/images/Good_result_1.jpg" width="320"/>
  <img src="docs/images/Good_result_2.jpg" width="320"/>
  <img src="docs/images/Good_result_3.jpg" width="320"/>
  <br/>
  <img src="docs/images/Good_result_4.jpg" width="320"/>
  <img src="docs/images/Good_result_5.jpg" width="320"/>
  <img src="docs/images/Good_result_6.jpg" width="320"/>
  <br/>
  <img src="docs/images/Good_result_7.jpg" width="320"/>
  <img src="docs/images/Good_result_8.jpg" width="320"/>
</div>
